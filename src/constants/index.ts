...
export default class {
  ...
  public static readonly MODS = [
    ...
    {
      logoUrl:
        'https://media.forgecdn.net/avatars/thumbnails/260/118/64/64/637213545206072680.png',
      engName: "Pam's HarvestCraft 2",
      chtName: '帕姆的種植模組',
      description: '新增各種農作物、食物和料理，適合喜歡農業的玩家。',
      curseforgeLink:
    ...
    {
      logoUrl:
        'https://media.forgecdn.net/avatars/thumbnails/178/942/64/64/636782028170955665.png',
      engName: "MrCrayfish's Furniture Mod",
      chtName: '小龍蝦先生的傢俱模組',
    ...
    {
      logoUrl:
        'https://media.forgecdn.net/avatars/thumbnails/91/358/64/64/636247292369687944.png',
      engName: 'OpenBlocks Elevator',
      chtName: '開放方塊 電梯',
      description: '增加了電梯功能的方塊，方便玩家建造自己電梯大樓。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/openblocks-elevator',
    },
    {
      logoUrl:
        'https://media.forgecdn.net/avatars/thumbnails/165/997/64/64/636695496359245657.png',
      engName: 'Simply Light',
      chtName: '簡易照明',
      description: '新增各種照明方塊。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/simply-light',
    },
    {
      logoUrl:
    ...
    },
    {
      ...
      engName: 'Mouse Tweaks',
      chtName: '滑鼠調整',
      description: '增加各種方便的滑鼠操作。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/mouse-tweaks',
    },
    {
    ...
    {
      logoUrl: 'https://media.forgecdn.net/avatars/thumbnails/49/603/64/64/636079972364045115.png',
      engName: 'Controlling',
      chtName: '控制性',
      description: '調整各個模組的快捷鍵設定。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/controlling',
    },
    {
    ...
    {
      logoUrl: 'https://media.forgecdn.net/avatars/thumbnails/296/106/64/64/637339400560627093.png',
      engName: 'FTB Chunks',
      chtName: '',
      description: '玩家可以宣告某些區塊為自己所有，安全的存放自己的寶藏，同時有大地圖功能。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/ftb-chunks',
    },
    {
      logoUrl: 'https://media.forgecdn.net/avatars/thumbnails/303/308/64/64/637371755397820308.png',
      engName: 'FTB Essentials',
      chtName: '',
      description: '添加各種方便的指令，如 /home、/back、/tpa <player> 等。',
      curseforgeLink: 'https://www.curseforge.com/minecraft/mc-mods/ftb-essentials',
    },
  ];
}
